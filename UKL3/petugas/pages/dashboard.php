<?php
session_start();
if ($_SESSION['status']!="login verified petugas"){
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 1276px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 1004px;"></div></div></aside>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none" onclick="location.href='logout.php'",<?session_destroy();?> Log Out ></span>
              </a>
            </li>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Online</p>
                    <h5 class="font-weight-bolder mb-0">
                      20
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Siswa Baru</p>
                    <h5 class="font-weight-bolder mb-0">
                      8
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Masuk</p>
                    <h5 class="font-weight-bolder mb-0">
                      Rp. 500.000,-
      ...
      <div class="row mt-4">
          ...
          <div class="card z-index-2">
            <div class="card-body p-3">
              <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                <div class="chart">
                  <canvas id="chart-bars" class="chart-canvas" height="340" style="display: block; box-sizing: border-box; height: 170px; width: 323px;" width="646"></canvas>
                </div>
              </div>
              <h6 class="ms-2 mt-4 mb-0"> Active Users </h6>
              <p class="text-sm ms-2"> (<span class="font-weight-bolder">+13%</span>) than last week </p>
              <div class="container border-radius-lg">
                <div class="row">
                  <div class="col-3 py-3 ps-0">
                    ...
                    <h4 class="font-weight-bolder">1500</h4>
        ...
        <div class="col-lg-7">
          <div class="card z-index-2">
            ...
            <div class="card-body p-3">
              <div class="chart">
                <canvas id="chart-line" class="chart-canvas" height="600" style="display: block; box-sizing: border-box; height: 300px; width: 480.3px;" width="960"></canvas>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 1295px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></main>
