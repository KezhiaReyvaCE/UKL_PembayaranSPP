  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/data_siswa.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  ...
                  <tbody>
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      ...
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $ceknisn?></p>
                      </td>
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $data['nis']?></p>
                      </td>
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $data['password']?></p>
                      </td> 
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $data['no_tlp']?></span>
                      </td>
                      <td class="align-middle text-center">
                      <button type="button" id="tombolubah" class="btn btn-succes" data-bs-toggle="modal" data-bs-target="#modaleditsiswa"
                      ...
                      data-no_tlp="<?php echo $data['no_tlp'];?>"
                      data-level="<?php echo $data['level'];?>">                       
                      Edit
                      </button>
                      </td>
                      <td>
                      <a href="deletesiswa.php?nisn=<?php echo $data['nisn']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                      </td>  
                    </tr>
                    <?php
                  }
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>NISN</label>
              <input type="number" name="nisn" class="form-control"  placeholder="Enter NISN">
            </div>

            <div class="form-group">
              <label>NIS</label>
              <input type="number" name="nis" class="form-control" placeholder="Enter NIS">
            </div>
            ...
            <div class="form-group">
              ...
              <input type="number" name="id_kelas" class="form-control" placeholder="Enter ID_Kelas">
            </div>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="tambahsiswa" class="btn btn-primary">Tambah Siswa</button>
          </div>
          </form>
        </div>
      </div>
...
<!-- ################################################################################################################################################### -->
    ...
    <?php
      ...
      // $query_mysql = mysqli_query($conn, "SELECT * FROM siswa WHERE nisn='$ceknisn'")or die(mysqli_error($conn));
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>NISN</label>
              <input type="number" name="nisn" id="nisn" class="form-control" placeholder="Enter NIS">
            </div>

            <div class="form-group">
              <label>NIS</label>
              <input type="number" name="nis" id="nis" class="form-control" placeholder="Enter NIS">
            </div>
            ...
            <div class="form-group">
              <label>Password</label>
              <input type="password" id="password" class="form-control" name="password" placeholder="Password" id="myPassword" value="">
                      <input type="checkbox" onclick="myFunction()"> Lihat Password
                      <script>
                      function myFunction() {
            ...
            <div class="form-group">
              <label>Alamat</label>
              <input type="text" name="alamat" id="alamat" class="form-control" placeholder="Enter Alamat">
            </div>

            <div class="form-group">
              <label>No Telepon</label>
              <input type="number" name="no_tlp" id="no_tlp" class="form-control" placeholder="Enter No Telepon">
            </div>

            <div class="form-group">
              <label>Level</label>
              <select name="level" id="level" class="form-control select2" style="width: 100%;">
                <option value="User" >-- Pilih Satu --</option>                
          ...
          $data = mysqli_fetch_array($row) ?>
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="submit" name="editsiswa" class="btn btn-primary">Edit Siswa</button>
            <a href="deletesiswa.php?nisn=<?php echo $data['nisn']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
          </div>
          </form>          
        </div>
